...
urlpatterns = [
    ...
    path('workouts/view/<int:workout_id>', views.view_workout, name='view_workout'),
    ...
    path('exercise-in-workout/delete/<int:workout_id>', views.delete_exercise_in_workout, name='delete_exercise_in_workout'),
